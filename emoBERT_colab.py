...
- save_dir default is "models_colab" instead of "models"
- synthetic csv is read from "./synthetic_claude.csv" (upload this file in colab)
"""
...
parser.add_argument("--save_dir", type=str, default="models_colab")
